...
namespace lab {
    ...
    struct Transform<F, 2> {
		...
		LAB_constexpr Matrix<F, 3, 3, Alignment> ToMatrix() const{
			...
			ret.columns[0].component[0] = scale.x * cosine;
			ret.columns[0].component[1] = scale.x * sine;
			ret.columns[0].component[2] = 0.f;

			ret.columns[1].component[0] = scale.y * -sine;
			ret.columns[1].component[1] = scale.y * cosine;
			ret.columns[1].component[2] = 0.f;

			ret.columns[2].component[0] = translation.x;
			ret.columns[2].component[1] = translation.y;
			ret.columns[2].component[2] = 1.f;
		...
		LAB_constexpr Matrix<F, 3, 3, Alignment> ToMatrixNoRotation() const {
			...
			ret.columns[0].component[0] = scale.x;

			ret.columns[1].component[1] = scale.y;
    ...
    struct Transform<F, 3> {
		...
		LAB_constexpr Matrix<F, 4, 4, Alignment> GetRotationXMatrix() const {
			...
			ret.columns[1].component[1] = cosRet;
			ret.columns[2].component[1] = -sinRet;
			ret.columns[1].component[2] = sinRet;
			ret.columns[2].component[2] = cosRet;
		...
		LAB_constexpr Matrix<F, 4, 4, Alignment> GetRotationYMatrix() const {
			...
			ret.columns[1].component[1] = F(1);
			ret.columns[3].component[3] = F(1);

			const F sinRet = Sin(rotation.y);
			const F cosRet = Cos(rotation.y);

			ret.columns[0].component[0] = cosRet;
			ret.columns[2].component[0] = sinRet;
			ret.columns[0].component[2] = -sinRet;
			ret.columns[2].component[2] = cosRet;
		...
		LAB_constexpr Matrix<F, 4, 4, Alignment> GetRotationZMatrix() const {
			...
			ret.columns[0].component[0] = cosRet;
			ret.columns[1].component[0] = -sinRet;
			ret.columns[0].component[1] = sinRet;
			ret.columns[1].component[1] = cosRet;
		...
		LAB_constexpr Matrix<F, 4, 4, Alignment> GetScaleMatrix() const {
			...
			ret.columns[0].component[0] = scale.x;
			ret.columns[1].component[1] = scale.y;
			ret.columns[2].component[2] = scale.z;
			ret.columns[3].component[3] = 1.f;
/*
			ret.columns[0].component[1) = 0.f;
			ret.columns[0].component[2) = 0.f;
			ret.columns[0].component[3) = 0.f;

			ret.columns[1].component[0) = 0.f;
			ret.columns[1].component[2) = 0.f;
			ret.columns[1].component[3) = 0.f;
			
			ret.columns[2].component[0) = 0.f;
			ret.columns[2].component[1) = 0.f;
			ret.columns[2].component[3) = 0.f;
*/
			return ret;
		}
		...
		LAB_constexpr Matrix<F, 4, 4, Alignment> GetMatrix() const {
			...
			ret.columns[0].component[0] = scale.x * (cosY * cosZ + sinY * sinX * sinZ);
			ret.columns[0].component[1] = scale.x * (cosX * sinZ);
			ret.columns[0].component[2] = scale.x * (cosY * sinX * sinZ - cosZ * sinY);
			ret.columns[0].component[3] = 0.f;

			ret.columns[1].component[0] = scale.y * (cosZ * sinY * sinX - cosY * sinZ);
			ret.columns[1].component[1] = scale.y * (cosX * cosZ);
			ret.columns[1].component[2] = scale.y * (cosY * cosZ * sinX + sinY * sinZ);
			ret.columns[1].component[3] = 0.f;

			ret.columns[2].component[0] = scale.z * (cosX * sinY);
			ret.columns[2].component[1] = scale.z * (-sinX);
			ret.columns[2].component[2] = scale.z * (cosY * cosX);
			ret.columns[2].component[3] = 0.0f;

			ret.columns[3].component[0] = translation.x;
			ret.columns[3].component[1] = translation.y;
			ret.columns[3].component[2] = translation.z;
			ret.columns[3].component[3] = 1.0f;
